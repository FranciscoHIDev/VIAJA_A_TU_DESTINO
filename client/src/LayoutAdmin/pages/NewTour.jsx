  ...
  buyLinks: yup
    ...
    .of(
      yup.object({
        ...
        price: yup.string().trim().required("El precio es requerido"),
        link: yup
          .string()
          .trim()
  ...
  if (loadingTour) {
    return (
      <div className="rounded-xl bg-white p-8 text-center">
        <p className="text-lg font-semibold text-[#035373]">Cargando tour...</p>
      </div>
    );
  }
    ...
    <div className="flex flex-col rounded-xl bg-white px-5 py-5">
          ...
          <div className="ml-2">
            ...
            <p className="text-sm text-gray-500">
              {isEditing
                ...
                : "Completa la información para crear una oferta de tour."}
            </p>
          </div>
        </div>
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <TextField fullWidth label="Categoría" value="Tour" disabled />
