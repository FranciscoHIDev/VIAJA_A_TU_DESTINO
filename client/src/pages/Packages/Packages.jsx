            ...
            <div className="mx-auto max-w-7xl">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="mt-5 leading-8 text-slate-600">
                  Encuentra opciones para viajar en pareja, con amigos o con
                  toda la familia.
                </p>
              </div>
            ...
            <div className="mx-auto max-w-[1500px]">
              ...
              <div className="mt-10 rounded-3xl border border-orange-200 bg-orange-50 p-6 text-center sm:p-8">
                <p className="font-bold leading-7 text-[#86420f]">
                  ...
                  sin previo aviso. El precio final dependerá de la ciudad de
                  salida, fechas, aerolínea, hotel, número de pasajeros y
                ...
                <div className="relative flex min-h-[430px] items-center px-7 py-14 sm:px-10 lg:px-16">
                  <div className="max-w-2xl text-white">
                    ...
                    <p className="mt-5 max-w-xl text-base leading-8 text-white/75 md:text-lg">
                      Algunas reservaciones permiten pagar a meses sin intereses
                      o apartar con un anticipo, dependiendo del proveedor y las
