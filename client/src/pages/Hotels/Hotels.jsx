          ...
          <div className="relative mx-auto flex min-h-[540px] max-w-7xl items-center px-5 pb-32 pt-16 sm:px-6 md:min-h-[620px] md:pb-40 lg:px-8">
            <div className="max-w-3xl text-white">
              ...
              <p className="mt-6 max-w-2xl text-base leading-8 text-white/80 sm:text-lg">
                Explora hoteles Todo Incluido, resorts frente al mar y opciones
                para parejas, familias o grupos en destinos nacionales e
                internacionales.
              </p>
              ...
              <div className="mt-2 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  <h2 className="text-xl font-black text-[#023e73] sm:text-2xl">
                    Busca hoteles al mejor precio disponible
                  </h2>

                  <p className="mt-2 text-sm leading-6 text-slate-500">
                    Selecciona el destino, las fechas y el número de huéspedes.
                  </p>
                </div>
          ...
          <div className="mx-auto max-w-[1500px]">
            ...
            <div className="mt-10 rounded-3xl border border-orange-200 bg-orange-50 p-6 text-center sm:p-8">
              <p className="font-bold leading-7 text-[#86420f]">
                ...
                previo aviso. El precio final dependerá del destino, las fechas,
                el número de huéspedes y el tipo de habitación seleccionado.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="px-4 py-16 sm:px-6 md:py-24 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-5 leading-8 text-slate-600">
                Te ayudamos a comparar opciones y conocer las condiciones de tu
                hospedaje antes de realizar la reservación.
              </p>
            </div>
