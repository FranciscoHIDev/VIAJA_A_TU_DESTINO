            ...
            <div className="relative z-20 mx-auto flex max-w-7xl flex-col gap-8 px-4 py-10 sm:px-6 sm:py-12 lg:h-full lg:flex-row lg:items-center lg:justify-between lg:gap-0 lg:px-10 lg:py-0">
              ...
              <div className="w-full max-w-3xl">
                <div className="flex flex-wrap gap-2 sm:gap-3">
                  ...
                  <span className="rounded-full bg-green-600 px-3 py-2 text-xs font-semibold text-white shadow-lg sm:px-5 sm:text-sm lg:text-base">
                    Actualizada Hoy
                  </span>
                </div>

                <h1 className="mt-6 break-words text-3xl font-black leading-tight text-white sm:mt-8 sm:text-4xl lg:text-5xl">
                  {offer.title}
                </h1>
                ...
                <div className="mt-6 flex flex-wrap gap-x-6 gap-y-3 text-base text-white sm:mt-8 sm:gap-8 sm:text-lg">
                  <div className="flex items-center gap-2">
                    <FaMapMarkerAlt className="text-[#ff6600]" />
                    Cancún
                  </div>
                ...
                <div className="mt-7 grid grid-cols-2 gap-3 sm:mt-10 sm:grid-cols-3 sm:gap-4 lg:flex lg:gap-5">
                  ...
                  <div className="col-span-2 flex items-center justify-center rounded-2xl bg-red-500 px-4 py-4 text-center text-white shadow-xl sm:col-span-1 sm:px-5 sm:py-5 lg:px-6">
                    <div className="font-bold">Últimos lugares</div>
                  </div>
                </div>
              </div>
              ...
              <div className="h-auto w-full overflow-hidden rounded-3xl border-4 border-sky-100 bg-white shadow-2xl sm:max-w-[620px] sm:self-center lg:h-[520px] lg:w-[390px] lg:max-w-none lg:shrink-0 lg:self-auto">
...
Quiero consultar fechas y disponibilidad.`,
          ...
          <section className="relative z-30 mx-auto -mt-6 max-w-7xl px-4 sm:-mt-8 sm:px-5 lg:-mt-10">
            <div className="grid grid-cols-1 overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-xl sm:grid-cols-2 lg:grid-cols-4">
              <div className="flex items-center gap-4 border-b border-gray-100 p-4 sm:border-r sm:p-6 lg:border-b-0">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-blue-50 text-2xl">
                  🛡️
                </div>
              ...
              <div className="flex items-center gap-4 border-b border-gray-100 p-4 sm:p-6 lg:border-b-0 lg:border-r">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-orange-50 text-2xl">
                  🔥
                </div>
              ...
              <div className="flex items-center gap-4 border-b border-gray-100 p-4 sm:border-b-0 sm:border-r sm:p-6">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-green-50 text-2xl">
                  💬
                </div>
